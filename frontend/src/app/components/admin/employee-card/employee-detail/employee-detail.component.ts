...
export class EmployeeDetailComponent implements OnInit, OnDestroy {
  ...
  constructor( @Inject(
    MAT_DIALOG_DATA ) public emp: Employee, private timeSheetService: WorklogService, private leaveService: LeaveService ) { }
  ...
  ngOnInit() {
    ...
    this.sheetSub = this.timeSheetService.fetchWorkLog( "empId", this.emp.empId ).subscribe( value => {
      if ( value ) {
